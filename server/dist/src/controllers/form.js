...
const createForm = (0, utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let { _id } = yield form_1.default.create(Object.assign(Object.assign({}, formDetail), { creatorId: user._id }));
    res.status(200).send({ formId: _id });
    (0, utils_1.screenShotFormPage)(_id.toString(), "form");
